 ...
 * @author Andy
 */
public class FormAnggota1841720026Ntsy extends javax.swing.JFrame {

    /**
     * Creates new form FormAnggota1841720002Andy
     */
    public FormAnggota1841720026Ntsy() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Anggota1841720026Ntsy> list = new Anggota1841720026Ntsy().getAll();
        Object rowData[] = new Object[4];
        
        tblAnggota.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (Anggota1841720026Ntsy ang : list) {
    ...
    public void cari (String keyword){
        String[] kolom = {"ID Anggota", "Nama", "Alamat", "Telepon"};
        ArrayList<Anggota1841720026Ntsy> list = new Anggota1841720026Ntsy().search(keyword);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggota1841720026Ntsy ang = new Anggota1841720026Ntsy().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        ang.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAnggota1841720026Ntsy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAnggota1841720026Ntsy().setVisible(true);
            }
        });
    }
