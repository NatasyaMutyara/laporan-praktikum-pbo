...
import backend1841720026Ntsy.Anggota1841720026Ntsy;
import backend1841720026Ntsy.Peminjaman1841720026Ntsy;
import backend1841720026Ntsy.Buku1841720026Ntsy;
 ...
 * @author Ela Widya
 */
public class FrmPeminjaman1841720026Ntsy extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman1841720126Ela
     */
    public FrmPeminjaman1841720026Ntsy() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720026Ntsy> list = new Peminjaman1841720026Ntsy().getAllEla();
    ...
    public void cariAnggota(String keyword){
        Anggota1841720026Ntsy anggota = new Anggota1841720026Ntsy().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNama());
    }
    
    public void cariBuku(String keyword){
        Buku1841720026Ntsy buku = new Buku1841720026Ntsy().getById(Integer.parseInt(keyword));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720026Ntsy pmj = new Peminjaman1841720026Ntsy();
        pmj.setIdpeminjamanEla(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720026Ntsy anggota = new Anggota1841720026Ntsy().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720026Ntsy buku = new Buku1841720026Ntsy().getById(Integer.parseInt(txtIdBuku.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720026Ntsy pmj = new Peminjaman1841720026Ntsy().getByIdEla(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.deleteEla();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720026Ntsy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720026Ntsy().setVisible(true);
            }
        });
    }
