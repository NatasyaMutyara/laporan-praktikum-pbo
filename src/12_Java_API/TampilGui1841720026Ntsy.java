 ...
 */
public class TampilGui1841720026Ntsy extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720026Ntsy DataMahasiswa;

    /**
     * Creates new form TampilGui
     */
    public TampilGui1841720026Ntsy() {
        DataMahasiswa = new InputData1841720026Ntsy();
        initComponents();
        LihatDataMahasiswa();
    }
    ...
    public final void LihatDataMahasiswa() {
        ...
        int i = 0;
        for(Mahasiswa1841720026Ntsy mhs: DataMahasiswa.getData()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720026Ntsy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720026Ntsy().setVisible(true);
            }
        });
    }
